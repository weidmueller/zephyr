 ...
 * Reset function for the Marvell Alaska (88E151x) PHY series
 *
 ...
 * Configuration function for the Marvell Alaska (88E151x) PHY series
 *
 * @param dev Pointer to the device data struct
 */
 ...
 * Status change polling function for the Marvell Alaska (88E151x) PHY series
 *
 * @param dev Pointer to the device data struct
 */
 ...
 * Link speed polling function for the Marvell Alaska (88E151x) PHY series
 *
 * @param dev Pointer to the device data struct
 ...
 * Function pointer table for the Marvell Alaska (88E151x) PHY series
